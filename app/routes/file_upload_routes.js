...
const FileUpload = require('../models/file_upload.js')

// require s3 file upload module
const awsFileUpload = require('../../lib/fileUploadAPI.js')
...
router.post('/fileUploads', upload.single('upload-test'), (req, res, next) => {
  ...
  awsFileUpload(req.file.originalname, req.file.buffer)
    .then(date => FileUpload.create(data))
    .catch(next)
